...
class GestureDetectorBounceable extends StatefulWidget {
  ...
  const GestureDetectorBounceable({
    Key? key,
    required this.onTap,
    required this.child,
    this.onTapUp,
  ...
  @override
  State<GestureDetectorBounceable> createState() =>
      _GestureDetectorBounceableState();
}

class _GestureDetectorBounceableState extends State<GestureDetectorBounceable>
