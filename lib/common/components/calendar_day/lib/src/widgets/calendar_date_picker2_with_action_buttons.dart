import 'package:cbp_mobile_app_flutter/common/components/calendar_day/lib/calendar_date_picker2.dart';
...
class _CalendarDatePicker2WithActionButtonsState
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (widget.config.disableCancelOkButton != true)
  ...
  void selectDate(List<DateTime?> values) {
    _editCache = values;
    if (widget.config.disableCancelOkButton == true) {
      confirmSelectDate();
    }
